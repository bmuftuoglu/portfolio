    ...
    <section id="contact" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold mt-3">Birlikte Çalışalım</h2>
          <p className="text-gray-400 mt-4 max-w-xl mx-auto">
            Bir projen mi var ya da sadece merhaba demek mi istiyorsun? Her zaman buradayım.
          </p>
        </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white/5 rounded-xl">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-white hover:text-purple-400 transition-colors text-sm"
                  >
                    linkedin.com/in/barışmüftüoğlu
                  </a>
                </div>
              </div>
            </div>
