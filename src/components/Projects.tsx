      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4 max-w-xl mx-auto">
            Üzerinde çalıştığım bazı projeler. Her biri bana yeni bir şey öğretti.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project) => (
            <div
              key={project.id}
              className="group bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-purple-500/40 hover:bg-white/8 transition-all duration-300"
            >
